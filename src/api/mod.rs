...
pub use misc::{
    ...
    api_delete_vertex_credential, api_get_cookies, api_get_gemini_cli_credentials, api_get_keys,
    api_get_models, api_get_vertex_credentials, api_post_cookie, api_post_gemini_cli_credential,
    api_post_key, api_post_vertex_credential, api_version,
};
